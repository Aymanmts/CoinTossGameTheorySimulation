...
class PlayGames():
    ...
    def play(self):
        self.game_type = '''Outputs/Cheat_Model_Memory/Announcements_NumGames-{}_InitialPlayerPotSize-{}_InitalHousePot-{}_ProbToGetCaught-{}%.txt'''.format(self.games_to_play,self.playerpot,self.initialpot,self.cheat_prob_caught) #Create logging (announcments) file
        self.dist_type = '''Outputs/Cheat_Model_Memory/Rounds_Distribution_NumGames-{}_InitialPlayerPotSize-{}_InitalHousePot-{}_ProbToGetCaught-{}%.pdf'''.format(self.games_to_play,self.playerpot,self.initialpot,self.cheat_prob_caught) #Create distribution summary pdf
        ...
        for trials in tqdm(range(1,self.games_to_play)): #Set number of games to play
            ...
            if (self.cheat_A_caught == None and self.cheat_B_caught ==None):
                for rounds in range(1,(self.maximum_rounds+1)): # set the maximum number of rounds a game will go on for 
                        ...
                        if gameover == "No": # Check if the game is still active and initiate the following loop.
                            ...
                            #Player A Cheats
                            #If player rolls a 4, 5, 6 and they have at least 1 item to give - they give 1 item to the pot. Player A will cheat here.
                                ...
                                print('Player A cheats- does he get caught?',self.cheat_A_caught,file = file)
                                
                                #If player A gets caught Player B gets mad and exits the game
                                if ((self.cheat_A_caught == 1) and (self.cheat_A == 1)):
                                    #Pot = Pot + PlayerAPot
                                    #PlayerBPot = PlayerBPot + Pot
                                    #PlayerAPot = 0
                                    gameover = "Yes"
                                    print("Is the game over ",gameover)
                            ...
                            #If player rolls a 4, 5, 6 and they have at least 1 item to give - they give 1 item to the pot                            
                                   ...
                                   #Check to see if Player B gets caught
                                    ...
                                    print('Player B cheats- does he get caught?',self.cheat_B_caught,file = file)
                                    
                                    #If player B gets caught Player A gets mad and leaves. The game ends.
